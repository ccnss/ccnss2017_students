    ...
    def get_outcome(self, state, action):
        ...
        if action == 0:  # move right
            ...
            if state == 38:  # goal state 1
                ...
                next_state = state + 15
            elif 13 <= state <= 157 and (state % 14 == 1 or state % 14 == 2 or state % 14 == 3):  # room 2 wind
                next_state = state - 13
    ...
    def get_outcome(self, state, action):
        ...
        if action == 0:  # move right
            ...
            if state == 38:  # goal state 1
                ...
                next_state = state - 13
            elif 6 <= state <= 75 and state % 14 == 5:  # room 1 left border
                next_state = state
            elif 105 <= state <= 160 and state % 14 == 7:  # room 2 right border
                next_state = state
            elif state % 14 == 13:  # world right border
                next_state = state
        elif action == 1:  # move up
            ...
            next_state = None
            reward = None
        return int(next_state) if next_state is not None else 5000, reward
